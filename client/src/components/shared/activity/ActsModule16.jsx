...
import qr from "../../../assets/optional_acts/main/module16/qr.jpeg"
import imgs from "../../../assets/optional_acts/main/module16/img.png"
import img from "../../../assets/optional_acts/main/module16/given.png"

import axios from 'axios'


export const ActsModule16 = () => {
    ...
    const save_act = (act_no) => {
        ...
        if (filedata != null) {
            ...
            axios.post("http://localhost:8000/api/activities/", formData, {
                ...
                setLoading(false)
                if (response.data.act_no == 31) {
                    setSubmitted(true)
                }
                if (response.data.act_no == 32) {
                    setSubmitted2(true)
                }
                setFileData(null)
            }).catch((err) => {
...
submission bin..</p>
       ...
       <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(31)} disabled={submitted} loading={loading}>Submit</Button>
       </form>
        ...
        <p className='text-base text-center  text-blue-gray-800 tracking-wide leading-7'><span className='font-bold text-lg'>Directions: </span>Go to https://nearpod.com/student/ and enter the code : <span className='text-blue-700 font-bold'>I2BHZ</span> . Play the time to climb
quiz game and enjoy while learning.</p>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(32)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
