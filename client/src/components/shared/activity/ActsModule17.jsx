...
import qr from "../../../assets/optional_acts/main/module17/qr.png"
import img from "../../../assets/optional_acts/main/module17/given.png"

import axios from 'axios'


export const ActsModule17 = () => {
    ...
    const save_act = (act_no) => {
        ...
        if (filedata != null) {
            ...
            axios.post("http://localhost:8000/api/activities/", formData, {
                ...
                setLoading(false)
                if (response.data.act_no == 33) {
                    setSubmitted(true)
                }
                if (response.data.act_no == 34) {
                    setSubmitted2(true)
                }
                setFileData(null)
            }).catch((err) => {
...
submission bin.</p>
       ...
       <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(33)} disabled={submitted} loading={loading}>Submit</Button>
       </form>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(34)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
