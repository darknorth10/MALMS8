...
import qr from "../../../assets/optional_acts/main/module18/qr.png"
import imgs from "../../../assets/optional_acts/main/module18/img.png"
import img from "../../../assets/optional_acts/main/module18/given.png"
import img2 from "../../../assets/optional_acts/main/module18/given2.png"

import axios from 'axios'


export const ActsModule18 = () => {
    ...
    const save_act = (act_no) => {
        ...
        if (filedata != null) {
            ...
            axios.post("http://localhost:8000/api/activities/", formData, {
                ...
                setLoading(false)
                if (response.data.act_no == 35) {
                    setSubmitted(true)
                }
                if (response.data.act_no == 36) {
                    setSubmitted2(true)
                }
                setFileData(null)
            }).catch((err) => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
        ...
        <p className='text-base text-center  text-blue-gray-800 tracking-wide leading-7'><span className='font-bold text-lg'>Directions: </span>Answer the following question in each task. Scan your work and upload it in
a PDF file to the submission bin.</p>
       ...
       <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(35)} disabled={submitted} loading={loading}>Submit</Button>
       </form>
        ...
        <div className='grid grid-cols-1 gap-5 items-center justify-center justify-items-center mb-8'>
            ...
            <a target='_blank' className='bg-blue-700 text-white px-8 py-2 rounded drop-shadow hover:bg-white hover:text-blue-700 border-4 border-blue-700 transition-all' href="https://view.genial.ly/65f1cef9a06dac0015878921/interactive-content-monomials-quiz">Click to Play</a>
            <img src={qr} alt={qr} />
        </div>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(36)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
