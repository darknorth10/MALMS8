...
import qr from "../../../assets/optional_acts/main/module23/qr.png"
import imgs from "../../../assets/optional_acts/main/module23/img.png"


import axios from 'axios'


export const ActsModule23 = () => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
        ...
        <div className='grid grid-cols-1 gap-7 items-center justify-center justify-items-center mb-8'>
            ...
            <a target='_blank' className='bg-green-700 text-white px-8 py-2 rounded drop-shadow hover:bg-white hover:text-green-700 border-4 border-green-700 transition-all' href="hhttps://www.proprofsgames.com/ugc/puzzle/sliding/conclusion-using-central-tendency/">Click to Play</a>
            <img src={qr} alt={qr} />
        </div>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(44)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
