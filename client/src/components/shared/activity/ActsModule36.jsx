...
import qr from "../../../assets/optional_acts/main/module36/qr.png"
import imgs from "../../../assets/optional_acts/main/module36/img.png"


import axios from 'axios'


export const ActsModule36 = () => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
        ...
        <p className='text-base text-center  text-blue-gray-800 tracking-wide leading-7'><span className='font-bold text-lg'>Directions: </span>Go to <a target='_blank' href="https://nearpod.com/student/">https://nearpod.com/student/</a> and enter the code: RLFQS to access the interactive activity. Or, you can scan the QR code below. Please take a screenshot of your work and upload it or attach the link in the submission bin.</p>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(57)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
