...
import imgs from "../../../assets/optional_acts/main/module42/img.png"


import axios from 'axios'


export const ActsModule42 = () => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(63)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
