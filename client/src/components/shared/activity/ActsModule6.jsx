...
import qr from "../../../assets/optional_acts/main/module6/qr.png"
import imgs from "../../../assets/optional_acts/main/module6/img.png"
import img from "../../../assets/optional_acts/main/module6/given.png"
import img2 from "../../../assets/optional_acts/main/module6/given1.png"
import axios from 'axios'


export const ActsModule6 = () => {
    ...
    const save_act = (act_no) => {
        ...
        if (filedata != null) {
            ...
            axios.post("http://localhost:8000/api/activities/", formData, {
                ...
                setLoading(false)
                if (response.data.act_no == 11) {
                    setSubmitted(true)
                }
                if (response.data.act_no == 12) {
                    setSubmitted2(true)
                }
                setFileData(null)
            }).catch((err) => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
       ...
       <div className='my-3 grid grid-cols-1'>
            ...
            <img className='mx-auto block' src={img2} alt="img2" />
       </div>
       ...
       <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(11)} disabled={submitted} loading={loading}>Submit</Button>
       </form>
        ...
        <div className='grid grid-cols-1 gap-5 items-center justify-center justify-items-center mb-8'>
            ...
            <a target='_blank' className='bg-green-700 text-white px-8 py-2 rounded drop-shadow hover:bg-white hover:text-green-700 border-4 border-green-700 transition-all' href="https://view.genial.ly/6604f13b1876e500146d08a2/interactive-content-ninja-quiz-multiplication-techniques-of-monomials-and-binomials">Click to Play</a>
            <img src={qr} alt={qr} />
        </div>
        ...
        <form encType='multipart/form-data' className='w-1/2 grid grid-cols-1 gap-7 mx-auto py-8'>
            ...
            <Button type='button' onClick={() => save_act(12)} disabled={submitted2} loading={loading}>Submit</Button>
       </form>
