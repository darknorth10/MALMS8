...
import module from "../../../assets/pdf/modules/mastery_2/module11.pdf"
...
import { ActsModule11 } from "../../../components/shared/activity/ActsModule11";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_11.png"
  ...
  export const Module11 = () => {
    ...
    const videoId = "y6_JGvTrbJ0"
    const videoId2 = "WVMrsAhX9u0"
    const url = "/formative/12/"
  
    const role = localStorage.getItem('role')
    
    useEffect(() => {

      if(current_mastery == 2.4) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Module 4"}/>,
      },
      {
        label: "Videos",
        value: "videos",
