...
import module from "../../../assets/pdf/modules/mastery_2/module14.pdf"
...
import { ActsModule14 } from "../../../components/shared/activity/ActsModule14";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_14.png"
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Module 7"}/>,
      },
      {
        label: "Videos",
        value: "videos",
