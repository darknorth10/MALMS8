...
import module from "../../../assets/pdf/modules/mastery_2/module9.pdf"
...
import { ActsModule9 } from "../../../components/shared/activity/ActsModule9";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_9.png"
  ...
  export const Module9 = () => {
    ...
    const videoId = "BTpraGsZmRY"
    const videoId2 = "ChNSv1Agcbk"

    
    const role = localStorage.getItem('role')
    const url = "/formative/10/"
    
    useEffect(() => {

      if(current_mastery == 2.2) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Module 2"}/>,
      },
      {
        label: "Videos",
        value: "videos",
