...
import module from "../../../assets/pdf/modules/mastery_3/module15.pdf"
...
import { ActsModule15 } from "../../../components/shared/activity/ActsModule15";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_15.png"
  ...
  export const Module15 = () => {
    ...
    const url = "/formative/16/"
    
    useEffect(() => {

      if(current_mastery == 3.1) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Module 1"}/>,
      },
      {
        label: "Videos",
        value: "videos",
