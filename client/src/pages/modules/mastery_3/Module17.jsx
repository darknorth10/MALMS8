...
import module from "../../../assets/pdf/modules/mastery_3/module17.pdf"
...
import { ActsModule17 } from "../../../components/shared/activity/ActsModule17";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_17.png"
  ...
  export const Module17 = () => {
    ...
    useEffect(() => {
      ...
      if(current_mastery == 3.3) {
        setDisable(false)
      }

    }, [])

    const videoId = "C_KffdI34ZU"
    const videoId2 = "if7EDy-2aPs"

    
    const role = localStorage.getItem('role')
    const url = "/formative/18/"
    
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Module 3"}/>,
      },
      {
        label: "Videos",
        value: "videos",
