...
import module from "../../../assets/pdf/modules/mastery_3/module19.pdf"
...
import { ActsModule19 } from "../../../components/shared/activity/ActsModule19";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_19.png"
  ...
  export const Module19 = () => {
    ...
    useEffect(() => {
      ...
      if(current_mastery == 3.5) {
        setDisable(false)
      }

    }, [])

    const videoId = "KxagblRDhC4"
    const videoId2 = "hE-IpXfAAv8"

    
    const role = localStorage.getItem('role')
    const url = "/formative/20/"
    
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Module 5"}/>,
      },
      {
        label: "Videos",
        value: "videos",
