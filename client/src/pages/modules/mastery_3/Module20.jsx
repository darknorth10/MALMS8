...
import module from "../../../assets/pdf/modules/mastery_3/module20.pdf"
...
import { ActsModule20 } from "../../../components/shared/activity/ActsModule20";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_20.png"
  ...
  export const Module20 = () => {
    ...
    const url = "/formative/21/"
    
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Module 6"}/>,
      },
      {
        label: "Videos",
        value: "videos",
