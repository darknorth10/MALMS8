...
import module1 from "../../../assets/pdf/modules/supp_1/module1.pdf"
...
import { ActsModule22 } from "../../../components/shared/activity/ActsModule22";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_22.png"
  ...
  export const Module22 = () => {
    ...
    const url = "/formative/26/"

    useEffect(() => {

      if(current_mastery == 4.1) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 1"}/>,
      },
      {
        label: "Videos",
        value: "videos",
