...
import module2 from "../../../assets/pdf/modules/supp_1/module2.pdf"
...
import { ActsModule23 } from "../../../components/shared/activity/ActsModule23";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_23.png"
  ...
  export const Module23 = () => {
    ...
    const url = "/formative/27/"

    useEffect(() => {

      if(current_mastery == 4.2) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 2"}/>,
      },
      {
        label: "Videos",
        value: "videos",
