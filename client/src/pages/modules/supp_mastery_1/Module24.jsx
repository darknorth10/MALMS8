...
import module3 from "../../../assets/pdf/modules/supp_1/module3.pdf"
...
import { ActsModule24 } from "../../../components/shared/activity/ActsModule24";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_24.png"
  ...
  export const Module24 = () => {
    ...
    const videoId = "o_4MV5Tz7r4"
    const videoId2 = "VT-VnYiByzU"
    
    const role = localStorage.getItem('role')
    const url = "/formative/28/"
    

    useEffect(() => {

      if(current_mastery == 4.3) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 3"}/>,
      },
      {
        label: "Videos",
        value: "videos",
