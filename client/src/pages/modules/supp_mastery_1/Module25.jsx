...
import module from "../../../assets/pdf/modules/supp_1/module4.pdf"
...
import { ActsModule25 } from "../../../components/shared/activity/ActsModule25";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_25.png"
  ...
  export const Module25 = () => {
    ...
    const videoId2 = "qFSxuBZvF00"
    
    const role = localStorage.getItem('role')
    const url = "/formative/29/"
    

    useEffect(() => {

      if(current_mastery == 4.4) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 4"}/>,
      },
      {
        label: "Videos",
        value: "videos",
