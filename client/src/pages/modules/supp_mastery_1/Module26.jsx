...
import module from "../../../assets/pdf/modules/supp_1/module5.pdf"
...
import { ActsModule26 } from "../../../components/shared/activity/ActsModule26";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_26.png"
  ...
  export const Module26 = () => {
    ...
    const url = "/formative/30/"
    

    useEffect(() => {

      if(current_mastery == 4.5) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 5"}/>,
      },
      {
        label: "Videos",
        value: "videos",
