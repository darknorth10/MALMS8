...
import module from "../../../assets/pdf/modules/supp_1/module6.pdf"
...
import { ActsModule27 } from "../../../components/shared/activity/ActsModule27";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_27.png"
  ...
  export const Module27 = () => {
    ...
    const url = "/formative/31/"

    useEffect(() => {

      if(current_mastery == 4.6) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 6"}/>,
      },
      {
        label: "Videos",
        value: "videos",
