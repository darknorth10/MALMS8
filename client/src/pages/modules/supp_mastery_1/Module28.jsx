...
import module from "../../../assets/pdf/modules/supp_1/module7.pdf"
...
import { ActsModule28 } from "../../../components/shared/activity/ActsModule28";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_28.png"
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 1 Supplementary Module 7"}/>,
      },
      {
        label: "Videos",
        value: "videos",
