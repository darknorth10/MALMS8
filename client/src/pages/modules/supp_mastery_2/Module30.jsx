...
import module2 from "../../../assets/pdf/modules/supp_2/module9.pdf"
...
import { ActsModule30 } from "../../../components/shared/activity/ActsModule30";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_30.png"
  ...
  export const Module30 = () => {
    ...
    const url = "/formative/34/"

    useEffect(() => {

      if(current_mastery == 5.2) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Supplementary Module 2"}/>,
      },
      {
        label: "Videos",
        value: "videos",
