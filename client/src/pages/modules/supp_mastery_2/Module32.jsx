...
import module from "../../../assets/pdf/modules/supp_2/module11.pdf"
...
import { ActsModule32 } from "../../../components/shared/activity/ActsModule32";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_32.png"
  ...
  export const Module32 = () => {
    ...
    const videoId = "JcWlHiuSQIs"

    
    const role = localStorage.getItem('role')
    const url = "/formative/36/"
    

    useEffect(() => {

      if(current_mastery == 5.4) {
        setDisable(false)
      }
