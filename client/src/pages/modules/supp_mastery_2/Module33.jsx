...
import module from "../../../assets/pdf/modules/supp_2/module12.pdf"
...
import { ActsModule33 } from "../../../components/shared/activity/ActsModule33";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_33.png"
  ...
  export const Module33 = () => {
    ...
    const url = "/formative/37/"
    

    useEffect(() => {

      if(current_mastery == 5.5) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Supplementary Module 5"}/>,
      },
      {
        label: "Videos",
        value: "videos",
