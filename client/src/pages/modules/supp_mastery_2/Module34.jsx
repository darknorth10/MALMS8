...
import module from "../../../assets/pdf/modules/supp_2/module13.pdf"
...
import { ActsModule34 } from "../../../components/shared/activity/ActsModule34";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_34.png"
  ...
  export const Module34 = () => {
    ...
    const url = "/formative/38/"

    useEffect(() => {

      if(current_mastery == 5.6) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Supplementary Module 6"}/>,
      },
      {
        label: "Videos",
        value: "videos",
