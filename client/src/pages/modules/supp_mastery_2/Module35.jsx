...
import module from "../../../assets/pdf/modules/supp_2/module14.pdf"
...
import { ActsModule35 } from "../../../components/shared/activity/ActsModule35";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_35.png"
  ...
  export const Module35 = () => {
    ...
    const url = "/formative/39/"
    const url2 = "/mastery/24/"
    

    useEffect(() => {
      if (current_mastery == 2.8) {
        setDisable(false)
      }

      if(current_mastery == 5.7) {
        setDisable2(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 2 Supplementary Module 7"}/>,
      },
      {
        label: "Videos",
        value: "videos",
   ...
   
      {
        ...
        <>
          ...
          <MasteryButton url={url2} disable={disable} level={2}/>
        </>,
      },
      {
        label: "References",
