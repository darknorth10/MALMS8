...
import module1 from "../../../assets/pdf/modules/supp_3/module15.pdf"
...
import { ActsModule36 } from "../../../components/shared/activity/ActsModule36";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_36.png"
  ...
  export const Module36 = () => {
    ...
    const url = "/formative/41/"

    useEffect(() => {

      if(current_mastery == 6.1) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Supplementary Module 1"}/>,
      },
      {
        label: "Videos",
        value: "videos",
