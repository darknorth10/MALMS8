...
import module from "../../../assets/pdf/modules/supp_3/module18.pdf"
...
import { ActsModule39 } from "../../../components/shared/activity/ActsModule39";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_39.png"
  ...
  export const Module39 = () => {
    ...
    const url = "/formative/44/"
    

    useEffect(() => {

      if(current_mastery == 6.4) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Supplementary Module 4"}/>,
      },
      {
        label: "Videos",
        value: "videos",
