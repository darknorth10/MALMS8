...
import module from "../../../assets/pdf/modules/supp_3/module19.pdf"
...
import { ActsModule40 } from "../../../components/shared/activity/ActsModule40";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_40.png"
  ...
  export const Module40 = () => {
    ...
    const url = "/formative/45/"
    

    useEffect(() => {

      if(current_mastery == 6.5) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Supplementary Module 5"}/>,
      },
      {
        label: "Videos",
        value: "videos",
