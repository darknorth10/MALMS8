...
import module from "../../../assets/pdf/modules/supp_3/module20.pdf"
...
import { ActsModule41 } from "../../../components/shared/activity/ActsModule41";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_41.png"
  ...
  export const Module41 = () => {
    ...
    const url = "/formative/46/"

    useEffect(() => {

      if(current_mastery == 6.6) {
        setDisable(false)
      }
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Supplementary Module 6"}/>,
      },
      {
        label: "Videos",
        value: "videos",
