...
import module from "../../../assets/pdf/modules/supp_3/module21.pdf"
...
import { ActsModule42 } from "../../../components/shared/activity/ActsModule42";
import { References } from "../../../components/shared/references/References";
import refImg from "../../../assets/refs/ref_42.png"
    ...
    const data = [
      {
        label: "Materials",
        value: "materials",
        desc: <Materials moduleSrc={`${moduleSrc}`} title={"Mastery Level 3 Supplementary Module 7"}/>,
      },
      {
        label: "Videos",
        value: "videos",
